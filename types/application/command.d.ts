...
declare class Command<T extends Function> {
    ...
    static createFromFunction<T extends Function = any>(runner: T, metadata: any, schemas: SchemaRegistry): Command<T>;
    static createFromObject<T extends Object>(obj: T, metadata: any, schemas: SchemaRegistry): {};
    private static extractSchemaCommand;
    readonly access: AccessFunction;
    readonly description?: string;
    constructor(runner: T, metadata: any, params: BaseField | null, body: CommandBodyType | null, returns: CommandReturnsType | null);
