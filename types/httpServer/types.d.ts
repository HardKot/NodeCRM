...
export type OctetStream = typeof Buffer | typeof Blob | typeof stream.Writable | typeof streamWeb.WritableStream | typeof stream.Readable | typeof streamWeb.ReadableStream;
...
export type TokenBlockedStatus = -1 | 0 | 1;
export interface ITokenRepository {
    ...
    isBlocked: (params: {
        refreshId?: string;
    }) => Promise<TokenBlockedStatus>;
}
export interface ISecurityGetaway {
    isTokenBlocked: (params: {
        refreshId?: string;
    }) => Promise<TokenBlockedStatus>;
    blockToken: (params: {
        refreshId?: string;
