...
import type { IPackageManager, IPackageBuilder } from './IPackageManager.ts';
import type { IBeanBuilder, IBeanRegistry } from '../beans/interfaces.js';
import type { IConfig } from './IConfig.ts';
import type { ISchemaManager } from './ISchemaManager.ts';
import type { ISpaceModule } from './ISpaceModule.ts';
