...
class HandleRequest {
  static fromCommand(cmd: CommandInfo): HandleRequest | null {
    ...
    const method = cmd.metadata
      .get<RESTMethod>(RequestMetadataKey.METHOD)
    ...
    return new HandleRequest(cmd.name, mapping, method, statusCode, cmd.body, cmd.params, cmd.returns);
  }
