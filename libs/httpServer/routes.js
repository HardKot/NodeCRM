...
class Routes {
    ...
    constructor(handlers) {
        ...
        const staticEntries = new Array(handlers.length);
    ...
    route(key, method) {
        ...
        if (!Types.isUndefined(staticIndex))
            return this.handlers[staticIndex];
        return this.findDynamicNode(key, method);
    }
    findDynamicNode(path, method) {
    ...
    getDynamicNode(mapping, method, index) {
