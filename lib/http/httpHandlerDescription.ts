...
abstract class HttpHandlerDescription implements IHttpHandlerDescription {
  #id: string;
  constructor() {
    if (Types.isPrototypeOf(this, HttpHandlerDescription)) {
  ...
  getMethod() {
    return Types.isNotImplementedError<IHttpMethodKey | 'UNKNOWN'>();
  }
