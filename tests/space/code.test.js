...
describe('Code', () => {
    ...
    it('Load CommonJS module', async () => {
        const code = new Code(`'use strict';
    ...
    it('Inject value into context', async () => {
      ...
      `, 'testModuleInject.cjs', undefined, undefined, undefined, undefined, undefined, undefined, ctx);
        await code.load();
    ...
    it('Import module in CommonJS', async () => {
      ...
      `, 'testModuleImport.cjs', undefined, mockRequire);
        await code.load();
    ...
    it.skip('Import module in ESM', async () => {
        ...
        export  { fs, path };
      `, 'testModuleImport.mjs', undefined, mockRequire);
        await code.load();
        expect(mockRequire).toHaveBeenCalledWith('fs');
        expect(mockRequire).toHaveBeenCalledWith('path');
    });
