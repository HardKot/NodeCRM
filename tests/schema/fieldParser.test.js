...
describe('SourceFieldParser', () => {
    ...
    it('should parse scalar field from string', () => {
        const stringField = sourceFieldParser.parse('string');
        const booleanField = sourceFieldParser.parse('boolean');
        const numberField = sourceFieldParser.parse('number');
        const intField = sourceFieldParser.parse('int');
        const enumField = sourceFieldParser.parse('enum,enum2,enum3');
    ...
    it('should parse optional scalar field from string', () => {
        const optionalStringField = sourceFieldParser.parse('?string');
    ...
    it('should parse field', () => {
        const arrayField = sourceFieldParser.parse(['string']);
        expect(arrayField).toBeInstanceOf(ArrayField);
        expect(arrayField.itemField).toBeInstanceOf(ScalarField);
        expect(arrayField.itemField.scalar).toBe(ScalarType.String);
    });
});
